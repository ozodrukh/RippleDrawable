...
public class DrawableUtils {
    private final static String LOGTAG = "WatchMeCommonUtils";
    /**
     ...
     * mode.
     */
    public static PorterDuffColorFilter updateTintFilter(Drawable drawable, PorterDuffColorFilter tintFilter, ColorStateList tint, Mode tintMode) {
